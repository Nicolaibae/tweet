...
import { Pagination, TweetParam, TweetQuery, TweetRequestBody} from "../model/request/tweet.requests";
import tweetService from "../services/tweets.service";
import { Tokenpayload } from "../model/request/user.request";
import { TweetType } from "../constants/enum";

export const createTweetController = async(req: Request<ParamsDictionary, any, TweetRequestBody>, res: Response, next: NextFunction) => {
