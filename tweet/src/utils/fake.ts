...
import { TweetRequestBody } from '../model/request/tweet.requests'
...
import { hassPassword } from './bycrypt'
...
const PASSWORD = 'Vinh263@'
// ID của tài khoản của mình, dùng để follow người khác
const MYID = new ObjectId('687dbc3de6f2422ea9c762e2')
    ...
    users.map(async (user) => {
      ...
      await databaseService.users.insertOne(
        new User({
          ...
          password: await hassPassword(user.password),
